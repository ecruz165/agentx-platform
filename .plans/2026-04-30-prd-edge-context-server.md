...
- **CS-7b** — **External-source ingestion via SKILL+CLI (F24):** Jira / Confluence / GitHub Issues adapters using `CredentialBroker` from agent-auth-lib; agent-triggered + scheduled paths (3 days)
